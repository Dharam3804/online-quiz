...
-- Generation Time: Aug 16, 2020 at 10:46 AM
...
(136, 19, 'how to get element in array?', 'a[i]', '[i]', 'a', 'ai', 1),
(135, 18, 'how to remove specific char from string?', 'remove()', 'delete()', 'erase()', 'remove', 3);
...
(17, '181112075', '75', 'dharam', 'Ddddddd.', 'indore', 2147483647, 'rajagupta@gmail.com');
